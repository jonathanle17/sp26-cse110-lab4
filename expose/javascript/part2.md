...
17. (17) [2, 4, 6], in the for loop, the callback function is called on the i value of the array and then pushed into the new array. In this scenario, the callback multiples the value by 2 so the double of the original array value is pushed into the new array and then returned after the for loop.
